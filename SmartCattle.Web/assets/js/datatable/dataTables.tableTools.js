...
TableTools.prototype = {
	...
	"_fnButtonDefinations": function ( buttonSet, wrapper )
	{
		...
		for ( var i=0, iLen=buttonSet.length ; i<iLen ; i++ )
		{
			if ( typeof buttonSet[i] == "string" )
			{
				...
				{
					alert( "1TableTools: Warning - unknown button type: "+buttonSet[i] );
					continue;
				}
			...
			else
			{
				...
				{
					alert( "2TableTools: Warning - unknown button type: "+buttonSet[i].sExtends );
					continue;
				}
	...
	/**
	 * Take account of scrolling in DataTables by  the full table
	 *  @returns void
	 *  @private 
	 */
	...
	/**
	 * Take account of scrolling in DataTables by  the full table. Note that the redraw of
	 ...
	 *  @param   {Node} nNode Element which should be  in a 'print' display
	 *  @returns void
	 *  @private 
	 */
