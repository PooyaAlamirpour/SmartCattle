            ...
            !this instanceof TableTools && alert("Warning: TableTools must be initialised with the keyword 'new'"); var r = n.fn.dataTable.Api ? new n.fn.dataTable.Api(t).settings()[0] : t.fnSettings(); return this.s = {
                ...
                copy: n.extend({}, TableTools.buttonBase, {
                    ...
                    fnClick: function (n, t, i) {
                        ...
                        var u = r.split("\n").length, f;
                        t.bHeader && u--; this.s.dt.nTFoot !== null && t.bFooter && u--; f = u == 1 ? "" : "s"; this.fnInfo("<h6>Table copied<\/h6><p>Copied " + u + " row" + f + " to the clipboard.<\/p>", 1500)
                    }
                }),
