...
{
    public class CattleFertilityStateTbl
    {
    ...
    class CattleFertilityStateTblMapping : ClassMap<CattleFertilityStateTbl>
    {
        public CattleFertilityStateTblMapping()
        {
            Id(x => x.ID);
            ...
            Table("SmartCattle.CattleFertilityStateTbl");
        }
    }
}
