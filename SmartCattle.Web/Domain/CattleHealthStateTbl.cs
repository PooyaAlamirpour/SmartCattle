...
{
    public class CattleHealthStateTbl
    {
    ...
    class CattleHealthStateTblMapping : ClassMap<CattleHealthStateTbl>
    {
        public CattleHealthStateTblMapping()
        {
            Id(x => x.ID);
            ...
            Table("SmartCattle.CattleHealthStateTbl");
        }
    }
}