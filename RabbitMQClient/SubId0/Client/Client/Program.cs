...
namespace Client
{
    class Program
    {
        private static int SubprojectID = 0;
        public static void Main(string[] args)
        {
            ...
            //_factory.UserName = "ipars";
            //_factory.Password = "api1397";
            //_factory.VirtualHost = "/";
            //_factory.HostName = "159.65.89.246";
            ...
            switch (type)
            {
                case "bodyTemperature":
                    ...
                    try
                    {
                        ...
                        EquipmentTbl _EquipmentTbl = sessionBodyTemp.QueryOver<EquipmentTbl>().Where(x => x.Mac == bodyTemperature.MAC).SingleOrDefault();
                        if(_EquipmentTbl != null)
                        {
                            _EquipmentTbl.Date2 = DateTime.Now.ToString("yyyy-MM-dd HH:mm");
                            sessionBodyTemp.Update(_EquipmentTbl);
                            sessionBodyTemp.Flush();
                        }
                ...
                case "activity":
                    ...
                    try
                    {
                        ...
                        sessionSensor.Clear();
                        BatteryLevelTbl _BatteryLevelTbl = new BatteryLevelTbl()
                        {
                            MacAddress = activity.MAC,
                            BatteryLevel = activity.batteryLevel,
                            Date = Utils.UnixTimeStampToDateTime(activity.detectorTime.ToString())
                        };
                        sessionSensor.Save(_BatteryLevelTbl);
                        sessionSensor.Clear();
                        ///////////////////////////////////////////////////////////////
                        EquipmentTbl _EquipmentTbl = sessionSensor.QueryOver<EquipmentTbl>().Where(x => x.Mac == activity.MAC).SingleOrDefault();
                        if (_EquipmentTbl != null)
                        {
                            _EquipmentTbl.Date2 = DateTime.Now.ToString("yyyy-MM-dd HH:mm");
                            sessionSensor.Update(_EquipmentTbl);
                            sessionSensor.Flush();
                        }
                ...
                case "position":
                    ...
                    try
                    {
                        ...
                        session.Clear();
                        ///////////////////////////////////////////////////////////////
                        EquipmentTbl _EquipmentTbl = session.QueryOver<EquipmentTbl>().Where(x => x.Mac == position.MAC).SingleOrDefault();
                        if (_EquipmentTbl != null)
                        {
                            _EquipmentTbl.Date2 = DateTime.Now.ToString("yyyy-MM-dd HH:mm");
                            session.Update(_EquipmentTbl);
                            session.Flush();
                        }
                ...
                case "ENV":
                    ...
                    try
                    {
                        ...
                        ///////////////////////////////////////////////////////////////
                        EquipmentTbl _EquipmentTbl = sessionEnviroment.QueryOver<EquipmentTbl>().Where(x => x.Mac == enviroment.MAC).SingleOrDefault();
                        if (_EquipmentTbl != null)
                        {
                            _EquipmentTbl.Date2 = DateTime.Now.ToString("yyyy-MM-dd HH:mm");
                            sessionEnviroment.Update(_EquipmentTbl);
                            sessionEnviroment.Flush();
                        }
                        ...
                        BatteryLevelTbl _BatteryLevelTbl = new BatteryLevelTbl()
                        {
                            MacAddress = enviroment.MAC,
                            BatteryLevel = enviroment.batteryLevel,
                            Date = Utils.UnixTimeStampToDateTime(enviroment.detectorTime.ToString())
                        };
                        sessionEnviroment.Save(_BatteryLevelTbl);
                        sessionEnviroment.Clear();
